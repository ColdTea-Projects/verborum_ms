 ...
 * <p>
 * ms_user is currently a publisher only — it declares the shared topic exchange and the dead letter
 * infrastructure, but no consumer queues. The `user.dictionary.imported` queue is added when ms_user
 * starts consuming `dictionary.imported` (roadmap P2-09).
 * <p>
